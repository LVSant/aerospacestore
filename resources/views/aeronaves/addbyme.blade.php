...
<div class="panel panel-default">
   <div class="panel-body">
      <div class="panel-heading">
         <h1> Gerenciador de minhas aeronaves </h1>
      Na tabela abaixo estão exibidas as aeronaves que você cadastrou no sistema, sendo possível realizar também a edição
      </div>
      <hr>
      @if(empty($aeronaves))
      ...
      <div class='row'>
         ...
         <div class="col-md-6">
            <div class='btn-group' role='busca' aria-pressed='true'>        
               ...
               Exibir buscador</a>
               <a class='btn btn-danger btn-sm' style="bottom: 10px;" data-toggle='limpabusca' href='{{url('/aeronaves/limparbuscame')}}' type='submit' aria-expanded='false' aria-controls='collapseExample'>Limpar busca</a>
              
              
               @if(Auth::user() && Auth::user()->tipo == 'J')
               <a class='btn btn-sm btn-success' style="bottom: 10px;" data-toggle='novaaeronave' href='{{url('aeronaves/novo')}}' type='submit' aria-expanded='true'>
   ...
   <div class="table-responsive">
      <table class="table table-hover table-striped table-condensed" >
         <tr>
            ...
            <td><a href="/aeronaves/addbyme?sort=Modelo&order=desc" > <span class="fa fa-sort-desc"></span><strong> Modelo</strong> </a></td>
            @else
            <td><a href="/aeronaves/addbyme?sort=Modelo&order=asc" > <span class="fa fa-sort-asc"></span><strong> Modelo</strong> </a></td>
            @endif
            @if(empty($sortPreco) || ($sortPreco == 'asc')) 
            <td><a href="/aeronaves/addbyme?sort=valor&order=desc" > <span class="fa fa-sort-desc"></span><strong> Preço</strong> </a></td>
            @else
            <td><a href="/aeronaves/addbyme?sort=valor&order=asc" > <span class="fa fa-sort-asc"></span><strong> Preço</strong> </a></td>
            @endif
            @if(empty($sortAno) || ($sortAno == 'asc')) 
            <td><a href="/aeronaves/addbyme?sort=Ano&order=desc" > <span class="fa fa-sort-desc"></span><strong> Ano de Fabricação</strong> </a></td>
            @else
            <td><a href="/aeronaves/addbyme?sort=Ano&order=asc" > <span class="fa fa-sort-asc"></span><strong> Ano de Fabricação</strong> </a></td>
            @endif
         ...
         <tr>
            ...
            <td> <a href="/aeronaves/edit/<?= $p->id ?>"> <span class="glyphicon glyphicon-cog"></span></a></td>
         </tr>
         @endforeach
      </table>
   </div>
