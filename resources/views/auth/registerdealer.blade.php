...
<form class="form-horizontal" action="{{url('/register')}}" method="post">
    <fieldset>
        ...
        <!-- Form Name -->
        <div class="panel panel-heading"><legend>Registra-se como Vendedor</legend></div>


        <!-- Text input-->
        <div class="form-group" {{ $errors->has('name') ? ' has-error' : '' }}>
            <label class="col-md-4 control-label " for="name">Nome Empresa</label>  
            <div class="col-md-4">
        ...
        <div class="form-group" {{ $errors->has('localizacao') ? ' has-error' : '' }}>
            <label class="col-md-4 control-label " for="localizacao">País de localização das aeronaves</label>  
            <div class="col-md-4">
                <input id="localizacao" name="localizacao" type="text" placeholder="Paris, France" value="{{old('localizacao')}}" class="form-control input-md" required=""/>
